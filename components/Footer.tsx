      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/institucional" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                  Sobre
                </Link>
              </li>
              <li>
                <Link href="/contato" className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary">
                  Contato
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-6">
          ...
          <div className="flex justify-center space-x-4 mt-2">
            <Link href="/termos" className="text-xs text-gray-500 dark:text-gray-400 hover:text-primary">
              Termos de Uso
            </Link>
            <Link href="/privacidade" className="text-xs text-gray-500 dark:text-gray-400 hover:text-primary">
